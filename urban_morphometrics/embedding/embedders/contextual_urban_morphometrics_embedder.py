"""
Contextual Urban Morphometrics Embedder.
...
class ContextualUrbanMorphometricsEmbedder(ContextualCountEmbedder):
    """
    Embedder that combines OSM feature counts with pre-aggregated morphological metrics.

    Inherits from ContextualCountEmbedder to calculate occurrences of OSM features, and then
    ...
    def __init__(
        ...
        super().__init__(
            ...
            num_of_multiprocessing_workers=num_of_multiprocessing_workers,
            multiprocessing_activation_threshold=multiprocessing_activation_threshold,
        )
